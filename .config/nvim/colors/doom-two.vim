...
let g:colors_name='doom-two'

hi Normal guifg=#abb2bf ctermfg=249 guibg=#171717 ctermbg=234 gui=NONE cterm=NONE
hi NormalNC guifg=#abb2bf ctermfg=249 guibg=#141414 ctermbg=234 gui=NONE cterm=NONE
hi Comment guifg=#6D6D6D ctermfg=65 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi Constant guifg=#FC9354 ctermfg=187 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi String guifg=#FBE3BF ctermfg=174 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Function guifg=#6699CC ctermfg=187 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Operator guifg=#FF5E5E ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Keyword guifg=#FF5E5E ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi ColorColumn guifg=NONE ctermfg=NONE guibg=#141414 ctermbg=236 gui=NONE cterm=NONE
hi CursorLineNr guifg=#abb2bf ctermfg=249 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi SignColumn guifg=NONE ctermfg=NONE guibg=#141414 ctermbg=234 gui=NONE cterm=NONE
hi Conceal guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CursorColumn guifg=NONE ctermfg=NONE guibg=#181818 ctermbg=236 gui=NONE cterm=NONE
...
hi StatusLine guifg=#abb2bf ctermfg=249 guibg=#050505 ctermbg=236 gui=NONE cterm=NONE
hi StatusLineNC guifg=#5c6370 ctermfg=241 guibg=#050505 ctermbg=NONE gui=NONE cterm=NONE
hi StatusLineTerm guifg=#abb2bf ctermfg=249 guibg=#050505 ctermbg=236 gui=NONE cterm=NONE
hi StatusLineTermNC guifg=#2c323c ctermfg=236 guibg=#050505 ctermbg=NONE gui=NONE cterm=NONE
...
hi Terminal guifg=#abb2bf ctermfg=249 guibg=#111111 ctermbg=234 gui=NONE cterm=NONE
...
hi TSComment guifg=#6D6D6D ctermfg=65 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSError guifg=#6D6D6D ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSPunctDelimiter guifg=#FF0000 ctermfg=249 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSConstant guifg=#FC9354 ctermfg=187 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSConstBuiltin guifg=#95d72b ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSNumber guifg=#FC9354 ctermfg=151 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSBoolean guifg=#95d72b ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSNamespace guifg=#cf81cf ctermfg=79 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSFuncBuiltin guifg=#dcdcaa ctermfg=187 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSFunction guifg=#5eadfc ctermfg=187 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSFuncMacro guifg=#C11971 ctermfg=187 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSParameter guifg=#FFB92C ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSParameterReference guifg=#9cdcfe ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSMethod guifg=#FF99CC ctermfg=187 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSField guifg=#35CDAF ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSConditional guifg=#FF2F00 ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSRepeat guifg=#FF2F00 ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSLabel guifg=#FF00AA ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSKeyword guifg=#d34444 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSKeywordFunction guifg=#FF7000 ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSKeywordOperator guifg=#569cd6 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSOperator guifg=#FF5E5E ctermfg=249 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSException guifg=#c586c0 ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSType guifg=#4cb763 ctermfg=79 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSTypeBuiltin guifg=#FF5000 ctermfg=74 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSStructure guifg=#ff00ff ctermfg=201 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSInclude guifg=#FC3500 ctermfg=175 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSVariable guifg=#d7af87 ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
" hi TSVariable guifg=#cf81cf ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSVariableBuiltin guifg=#f96f2d ctermfg=153 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi BufferVisible guifg=#abb2bf ctermfg=249 guibg=#FFFFFF ctermbg=234 gui=NONE cterm=NONE
...
hi BufferInactive guifg=#858585 ctermfg=102 guibg=#FFFFFF ctermbg=236 gui=NONE cterm=NONE
...
hi NeoTreeNormal guifg=#abb2bf ctermfg=249 guibg=#111111 ctermbg=000 gui=NONE cterm=NONE
hi NeoTreeNormalNC guifg=#abb2bf ctermfg=249 guibg=#111111 ctermbg=000 gui=NONE cterm=NONE
...
hi dashBoardHeader guibg=NONE guifg=#ff5e00
hi dashBoardCenter guibg=NONE guifg=#00ff66
