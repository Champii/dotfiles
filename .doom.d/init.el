...
(doom! :input
       ...
       (python +cython +lsp +pyright +conda +poetry)            ; beautiful is better than ugly
...
;; (require 's)
(add-to-list 'load-path "/home/champii/.emacs.doom/site-lisp/emacs-application-framework")
